...
class StatsGrid extends StatelessWidget {
  ...
  final VoidCallback? onGrammarCheckTap;
  final VoidCallback? onGrammarScoreTap;
  ...
  const StatsGrid({
    ...
    this.onGrammarCheckTap,
    this.onGrammarScoreTap,
  });
